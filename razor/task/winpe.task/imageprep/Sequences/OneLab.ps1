...
@(
  ...
  #     script = { New-LocalAdministrativeUser -Username "Administrator" -Password "tally.h0" -Verbose:$VerbosePreference -ea 0 };
  #     pre    = { if ( (Get-CurrentDomain).PartOfDomain ) { Throw "Computer is a domain member." } }; post   = { 1 }; }
  # # Backup administrator
  # @{ name    =   'create_local_administrator_citrix';
  #     script = { New-LocalAdministrativeUser -Username "citrix" -Password "tally.h0" -Verbose:$VerbosePreference -ea 0 };
  #     pre    = { if ( (Get-CurrentDomain).PartOfDomain ) { Throw "Computer is a domain member." } }; post   = { 1 }; }
